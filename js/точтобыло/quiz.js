...
submit.addEventListener('click', () => {
    ...
    if(answer){
        ...
        if(currentQuiz < quizData.length){
            ...
            quiz.innerHTML = `<h2 class="quizh2">You answered coreectly at ${score}/${quizData.length} questions</h2>
            <button class="button_quiz" onclick="location.reload()">Reload</button>
            `;
        }
    }
});